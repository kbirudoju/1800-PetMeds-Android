...
public class CustomDatePicker extends DatePicker
{
    ...
    public CustomDatePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(monthNumberPicker, getResources().getColor(R.color.gray_holo_light));
            selectionDividerField.set(dayNumberPicker, getResources().getColor(R.color.gray_holo_light));
            selectionDividerField.set(yearNumberPicker, getResources().getColor(R.color.gray_holo_light));
        }
