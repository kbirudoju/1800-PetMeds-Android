...
public class PermissionUtils extends ContextWrapper {
    ...
    public void askUserForPermission(final FragmentActivity activity, final String permission, final int permissionCode,
    ...
    private void showPermissionRationaleDialog(FragmentActivity activity, String message,
            BaseDialogFragment.DialogButtonsListener okListener) {
