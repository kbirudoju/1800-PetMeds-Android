...
public interface AddACardContract {
    ...
    interface View extends BaseView<Presenter> {
        ...
        /**
         * All error should be passed on through this method, applicable to "Editing a Card" flow.This would actually
         * provide a way to the user to retry. (For "Add a Card" flow we already have a tick action item button.)
         */
