...
public class MonthYearPicker {
    ...
    public void build(int selectedMonth, int selectedYear, DialogInterface.OnClickListener positiveButtonListener,
        ...
        builder.setTitle(activity.getString(R.string.title_expirationDateDialog));
        builder.setPositiveButton(activity.getString(R.string.saveTextOnDialog), positiveButtonListener);
        builder.setNegativeButton(activity.getString(R.string.cancelTextOnDialog), negativeButtonListener);
