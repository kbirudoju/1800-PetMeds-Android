...
public class CommonWebviewFragment extends AbstractFragment {
    ...
    public static CommonWebviewFragment newInstance(boolean disableBackButton) {
        Log.w("CommonWebviewFragment", "newInstance Enter");
    ...
    public void onAttach(Activity activity) {
        Log.w("CommonWebviewFragment", "onAttach Enter");
        ...
        Log.w("CommonWebviewFragment", "onAttach Exit");
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        Log.w("CommonWebviewFragment", "onCreate Enter");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Log.w("CommonWebviewFragment", "onCreateView Enter");
        ...
        Log.w("CommonWebviewFragment", "onCreateView set accept third party cookies Called");

        Log.w("CommonWebviewFragment", "onCreateView Exit");
        return rootView;
    }
    ...
    public void onResume() {
        super.onResume();
        Log.w("CommonWebviewFragment", "onResume Enter");
        ...
        Log.w("CommonWebviewFragment", "onResume Exit");
    }

    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        Log.w("CommonWebviewFragment", "onViewCreated Enter");
        ...
        Log.w("CommonWebviewFragment", "onViewCreated Exit");
    }

    private void setUpWebView(final String url) {
        Log.w("CommonWebviewFragment", "setUpWebView Enter");
        ...
        Log.w("CommonWebviewFragment", "setUpWebView Exit");
    }

    private void loadFromHtmlData(String htmlData) {
        Log.w("CommonWebviewFragment", "loadFromHtmlData Enter");
        ...
        Log.w("CommonWebviewFragment", "loadFromHtmlData Exit");
    }

    private void loadHtmlWithPostRequest(String postData) {
        Log.w("CommonWebviewFragment", "loadHtmlWithPostRequest Enter");
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
            Log.d("setUpWebView", "Using clearCookies code for API >=" + String.valueOf(Build.VERSION_CODES.LOLLIPOP_MR1));
            CookieManager.getInstance().setCookie(postData, (String) cookieMap.get("JSESSIONID"));
            CookieManager.getInstance().setCookie(postData, (String) cookieMap.get("SITESERVER"));
            CookieManager.getInstance().flush();
        } else {
            Log.d("setUpWebView", "Using clearCookies code for API <" + String.valueOf(Build.VERSION_CODES.LOLLIPOP_MR1));
            CookieSyncManager cookieSyncMngr = CookieSyncManager.createInstance(mWebView.getContext());
            cookieSyncMngr.startSync();
            CookieManager cookieManager = CookieManager.getInstance();
            cookieManager.setCookie(postData, (String) cookieMap.get("JSESSIONID"));
            cookieManager.setCookie(postData, (String) cookieMap.get("SITESERVER"));
            cookieSyncMngr.stopSync();
            cookieSyncMngr.sync();
        }
        SystemClock.sleep(1000);
        ...
        Log.w("CommonWebviewFragment", "loadHtmlWithPostRequest Exit");
    }

    @Override
    public void onDestroyView() {
        Log.w("CommonWebviewFragment", "onDestroyView Enter");
        deregisterIntent(getContext());
        super.onDestroyView();
        Log.w("CommonWebviewFragment", "onDestroyView Exit");
    }
