...
public class ConfirmationReceiptRootFragment extends AbstractFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        transaction.replace(R.id.container_fragment_receipt, ConfirmationReceiptFragment.newInstance((CommitOrderResponse) getArguments().getSerializable(Constants.CONFIRMATION_ORDER_RESPONSE)), ConfirmationReceiptFragment.class.getSimpleName());
        transaction.commit();
        return view;
    }
